...
Note: If both black and white lists are filled, both policies will take effect.',
  ...
  'admin/system/configapi/datafilter_tip_manga'=>'SQL query condition e.g. manga_status=1',
    ...
    'admin/tpl/config/allmenu_tip' => 'Configure the category ID, name and icon (up to 20 items) displayed in the sidebar/pop-up layer of "All Categories".',
    ...
    'admin/tpl/config/key35' => 'Navigation categories to be displayed, leave blank to display all, separate multiple IDs with ","',
